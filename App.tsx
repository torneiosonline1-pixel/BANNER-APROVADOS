...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-blue-500 selection:text-white font-sans">
      {/* Navbar simplificada estilo Dashboard */}
      <nav className="border-b border-white/5 bg-[#0a0a0a]/50 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
           <div className="flex items-center gap-3">
             ...
             <span className="font-display font-bold text-xl tracking-wider">JDES ACADEMY <span className="text-yellow-500 text-sm align-top">V6</span></span>
           </div>
        ...
        <main className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 xl:col-span-7">
             <div className="mb-6 border-l-4 border-yellow-500 pl-4">
                ...
                <p className="text-slate-400 text-sm">Sistema oficial JDES Academy: Face Lock Absoluto + Status Inteligente.</p>
             </div>
          ...
          <div className="lg:col-span-5 xl:col-span-5 space-y-6">
            <div className="sticky top-24">
              <div className="flex items-center justify-between mb-4">
                 ...
                 {resultImage && (
                   <span className="text-xs font-mono text-green-400 border border-green-500/30 px-2 py-0.5 rounded bg-green-500/10">RENDER_SUCCESS</span>
                 )}
              </div>
                  ...
                  {isGenerating ? (
                     <div className="absolute inset-0 bg-black/80 backdrop-blur-sm z-20 flex flex-col items-center justify-center p-8 text-center space-y-6">
                      ...
                      <div className="space-y-2">
                        <h3 className="text-lg font-bold text-white font-display tracking-wider">PROCESSANDO V6...</h3>
